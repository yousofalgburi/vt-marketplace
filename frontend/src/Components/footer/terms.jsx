                        ...
                        <li>
                            ...
                            <p>When people stand behind their opinions and actions, our community is safer and more accountable. For this reason, you must:
                                <ul>
                                    ...
                                    <li>Not share your password, give access to your Marketplace account to others, or transfer your account to anyone else (without our permission).</li>
                                </ul> <br></br>
                                    
                                We try to make Marketplace broadly available to everyone, but you cannot use Marketplace if:
                                <ul>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <p>We want VT Marketplace to be a place where people feel welcome and safe to express themselves and share their thoughts and ideas.If we determine, in our discretion,
                                ...
                                your access to VT Marketplace Products, and we may permanently disable or delete your account. We may also disable or delete your account if you repeatedly infringe
                                other people’s intellectual property rights or where we are required to do so for legal reasons.</p>
