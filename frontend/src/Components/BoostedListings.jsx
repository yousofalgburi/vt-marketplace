    ...
    return (
        <div className="boosted-listings-container">
            <div className="boosted-header">
                ...
                <p>Reach more potential buyers and make your Marketplace items stand out by through Marketplace boosted listings.</p> <br></br>
            ...
            <div className='boosting-faqs'>
                ...
                <div className="faq-item">
                    ...
                    <div className={`faq-answer ${activeIndex === 0 ? "show" : ""}`}>
                        They appear in online News Feed like Marketplace Search, Marketplace Product Detail Pages, Marketplace Browse and Marketplace Category pages.
                    </div>
                </div>
