...
function Finding() {
    ...
    return (
        <div className="finding-things-container">
            <h1>Finding Items through VT Marketplace</h1>
            ...
            <ol>
                <li>Select the <b>"GO TO MARKETPLACE"</b> button at the top right of the webiste.</li>
                <li>There will be a button that says "Select Category". It will show a list of categories to begin your search.</li>
            </ol>

            <h3>Search for for something specific</h3>
            <p>If you know exactly what you're looking for, you can just type it in the search bar.</p>
            <ol>
                <li>Click on the <b>"GO TO MARKETPLACE"</b> button at the top right of the website</li>
